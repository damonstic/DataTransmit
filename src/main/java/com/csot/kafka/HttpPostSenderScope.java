...
@Component
public class HttpPostSenderScope {
    private final static Logger logger = LoggerFactory.getLogger(HttpPostSenderScope.class);
    ...
    @Autowired
    public HttpPostSenderScope(RestTemplate restTemplate) {
